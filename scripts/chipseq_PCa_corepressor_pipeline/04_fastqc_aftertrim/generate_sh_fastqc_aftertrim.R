...
for (i in 1:nrow(df)) {
  ...
  #
  file_sh1 <- file.path("scripts", script_pipeline_dir, "04_fastqc_aftertrim/batch_sh",
  ...
  #
  file_sh2 <- file.path("scripts", script_pipeline_dir, "04_fastqc_aftertrim/batch_sh",
